...
## Código en python para visualizar la solución
  ...
  <button class="btncode" style=" top: 5px; right: 5px;" onclick="copyCode()">Copiar código</button>
...
t = np.linspace(0, T, 50) # Puntos en el eje t
...
ax.set_zlabel('u(x,t) distribución de calor (C°) ') 
...
<div style="position: relative;">
  <button style="position: absolute; top: 5px; right: 5px;" onclick="copyCode()">Copiar código</button>
...
[![](/assets/img/calor_grafica.png)](/assets/img/calor_grafica.png)
<figcaption> Fig: <b>Heat Solution for  L= 5 , K=0.1 </b> </figcaption>
